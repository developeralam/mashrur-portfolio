            ...
            <div class="flex-wrap d-flex align-items-stretch">
                ...
                <div class="order-2 bg-white col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="mt-5 text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Mashrur Official</span>
                        </h4>
                        <p class="text-muted">Before you get started, you must login here.</p>
                        <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                            @csrf
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input id="email" type="email" class="form-control" name="email"
                                    value="{{ old('email') }}" autocomplete="email" tabindex="1" required autofocus>
                                @error('email')
